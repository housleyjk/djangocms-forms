...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormDefinition.email_template'
        db.add_column(u'djangocms_forms_formdefinition', 'email_template',
                      self.gf('django.db.models.fields.CharField')(default=u'djangocms_forms/email_template/default.txt', max_length=150, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormDefinition.email_template'
        db.delete_column(u'djangocms_forms_formdefinition', 'email_template')
    ...
    models = {
        ...
        u'djangocms_forms.formdefinition': {
            ...
            'email_template': ('django.db.models.fields.CharField', [], {'default': "u'djangocms_forms/email_template/default.txt'", 'max_length': '150', 'blank': 'True'}),
